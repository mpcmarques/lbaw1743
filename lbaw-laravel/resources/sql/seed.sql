...
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('ejurgesd', '3weUjK', 'ejurgesd@g.co', false, false, 'Elinore Jurges', 'Female', '539 Maple Wood Way', 'Oyonder', 'In congue. Etiam justo. Etiam pretium iaculis justo.', '1996-05-04', 14);
