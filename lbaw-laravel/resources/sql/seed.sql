...
--Users
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('pputman0', crypt('PHreK9plUZ8', gen_salt('bf')), 'pputman0@usnews.com', true, false, 'Pincus Putman', 'Male', '8 Spaight Terrace', 'Demizz', 'Aenean fermentum. Donec ut mauris eget massa tempor convallis. Nulla neque libero, convallis eget, eleifend luctus, ultricies eu, nibh.', '1994-12-11', 1);
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('belliker1', crypt('vUf5vxe', gen_salt('bf')), 'belliker1@gravatar.com', true, false, 'Betsey Elliker', 'Female', '2216 Nancy Way', 'Brainverse', 'Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla. Sed vel enim sit amet nunc viverra dapibus. Nulla suscipit ligula in lacus.', '1998-03-24', 2);
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('pfiggs2', crypt('jFY5qeZeAT0C', gen_salt('bf')), 'pfiggs2@google.com.br', true, false, 'Pearla Figgs', 'Female', '854 Cambridge Pass', 'Vitz', 'Curabitur in libero ut massa volutpat convallis. Morbi odio odio, elementum eu, interdum eu, tincidunt in, leo. Maecenas pulvinar lobortis est.', '1991-02-19', 3);
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('pmenendes3',  crypt('yBU47k5sIVop', gen_salt('bf')), 'pmenendes3@mlb.com', true, false, 'Patsy Menendes', 'Male', '28 Evergreen Hill', 'Oyope', 'Vestibulum ac est lacinia nisi venenatis tristique. Fusce congue, diam id ornare imperdiet, sapien urna pretium nisl, ut volutpat sapien arcu sed augue. Aliquam erat volutpat.', '1998-08-27', 4);
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('rmathie4', crypt('frrEEWm', gen_salt('bf')), 'rmathie4@nih.gov', true, false, 'Rory Mathie', 'Female', '792 Garrison Park', 'Devcast', 'Fusce posuere felis sed lacus. Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl. Nunc rhoncus dui vel sem.', '1994-09-06', 5);
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('kmcritchie5',  crypt('ZZzD5chsNR', gen_salt('bf')), 'kmcritchie5@ed.gov', false, true, 'Kattie McRitchie', 'Female', '98951 Hudson Crossing', 'Skyndu', 'Morbi non lectus. Aliquam sit amet diam in magna bibendum imperdiet. Nullam orci pede, venenatis non, sodales sed, tincidunt eu, felis.', '1991-10-05', 6);
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('pkeaves6',  crypt('2zTXjXTFUo', gen_salt('bf')), 'pkeaves6@is.gd', false, false, 'Puff Keaves', 'Male', '4 Saint Paul Trail', 'Livepath', 'Proin interdum mauris non ligula pellentesque ultrices. Phasellus id sapien in sapien iaculis congue. Vivamus metus arcu, adipiscing molestie, hendrerit at, vulputate vitae, nisl.', '1992-05-22', 7);
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('lsoles7',  crypt('DODIswuA', gen_salt('bf')), 'lsoles7@admin.ch', false, false, 'Leesa Soles', 'Female', '2 Oak Valley Way', 'Centizu', 'Proin interdum mauris non ligula pellentesque ultrices. Phasellus id sapien in sapien iaculis congue. Vivamus metus arcu, adipiscing molestie, hendrerit at, vulputate vitae, nisl.', '1994-09-15', 8);
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('dstruttman8',  crypt('rMw3Om', gen_salt('bf')), 'dstruttman8@spotify.com', false, false, 'Dareen Struttman', 'Female', '891 Meadow Valley Terrace', 'Topiclounge', 'Maecenas leo odio, condimentum id, luctus nec, molestie sed, justo. Pellentesque viverra pede ac diam. Cras pellentesque volutpat dui.', '1996-06-22', 9);
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('swaylen9',  crypt('3tkxbpaRq5Q', gen_salt('bf')), 'swaylen9@biglobe.ne.jp', false, false, 'Sibelle Waylen', 'Female', '911 Paget Alley', 'Podcat', 'Quisque porta volutpat erat. Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla. Nunc purus.', '1993-05-20', 10);
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('bjigglea',  crypt('S5xRwPhB', gen_salt('bf')), 'bjigglea@yahoo.co.jp', false, false, 'Berkly Jiggle', 'Male', '00981 Packers Place', 'Gabcube', 'In hac habitasse platea dictumst. Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante. Nulla justo.', '1994-11-14', 11);
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('cjulianb',  crypt('WDAd613zAs', gen_salt('bf')), 'cjulianb@abc.net.au', false, false, 'Coop Julian', 'Male', '9791 Mcguire Drive', 'Tagfeed', 'Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus.', '1990-07-31', 12);
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('ltwidlec',  crypt('ZtbKXID', gen_salt('bf')), 'ltwidlec@freewebs.com', false, false, 'Linnea Twidle', 'Female', '2915 North Circle', 'Feedfire', 'Integer tincidunt ante vel ipsum. Praesent blandit lacinia erat. Vestibulum sed magna at nunc commodo placerat.', '1993-04-16', 13);
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('ejurgesd',  crypt('3weUjK', gen_salt('bf')), 'ejurgesd@g.co', false, false, 'Elinore Jurges', 'Female', '539 Maple Wood Way', 'Oyonder', 'In congue. Etiam justo. Etiam pretium iaculis justo.', '1996-05-04', 14);
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('ilanone',  crypt('c34fVIFUP8SQ', gen_salt('bf')), 'ilanone@diigo.com', false, false, 'Isak Lanon', 'Male', '2 Oakridge Court', 'Blogtags', 'Fusce posuere felis sed lacus. Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl. Nunc rhoncus dui vel sem.', '1999-06-07', 15);
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('dscranneyf',  crypt('ZasqJSdgH2', gen_salt('bf')), 'dscranneyf@narod.ru', false, false, 'Dusty Scranney', 'Female', '8 Montana Pass', 'Kazio', 'Cras non velit nec nisi vulputate nonummy. Maecenas tincidunt lacus at velit. Vivamus vel nulla eget eros elementum pellentesque.', '1994-05-25', 16);
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('cstanlackg',  crypt('lRBgvAV', gen_salt('bf')), 'cstanlackg@simplemachines.org', false, false, 'Cathee Stanlack', 'Female', '97 Thierer Lane', 'Dabvine', 'Curabitur gravida nisi at nibh. In hac habitasse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem.', '1993-06-03', 17);
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('ccrinageh',  crypt('zy5pNl2rC', gen_salt('bf')), 'ccrinageh@yellowbook.com', false, false, 'Chrystal Crinage', 'Female', '385 Northland Alley', 'Blogtags', 'Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.', '1991-02-12', 18);
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('lcasini',  crypt('LFj7FG4cn', gen_salt('bf')), 'lcasini@admin.ch', false, false, 'Louella Casin', 'Female', '8543 Manufacturers Trail', 'Topicshots', 'Morbi porttitor lorem id ligula. Suspendisse ornare consequat lectus. In est risus, auctor sed, tristique in, tempus sit amet, sem.', '1992-05-06', 19);
insert into usertable (username, password, email, premium, banned, name, gender, address, institution, description, birthDate, idCountry) values ('npallaschj', crypt('lANindUcz6', gen_salt('bf')), 'npallaschj@addtoany.com', false, false, 'Neile Pallasch', 'Female', '17881 Gulseth Avenue', 'Realpoint', 'Morbi non lectus. Aliquam sit amet diam in magna bibendum imperdiet. Nullam orci pede, venenatis non, sodales sed, tincidunt eu, felis.', '1990-07-11', 20);
...
--Admin
insert into admin (username, email, password) values ('barbosa','up201503477@fe.up.pt' ,'03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4');
insert into admin (username, email, password) values ('mario','up201503406@fe.up.pt' ,'03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4');
insert into admin (username, email, password) values ('mateus','up201601876@fe.up.pt' ,'03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4');
insert into admin (username, email, password) values ('jotapsa','up201506252@fe.up.pt' ,'03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4');
