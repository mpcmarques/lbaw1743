...
<table>
  ...
  <tr>
    ...
    <td>
      {username}->{idUser, password, email, premium, banned, name, gender, address, institution, description, birthDate}
    </td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    ...
    <td>
      {email}->{idUser, username, password, premium, banned, name, gender, address, institution, description, birthDate}
    </td>
  </tr>
  <tr>
    <td>
...
<table>
  ...
  <tr>
    ...
    <td>
      {idTask}->{creationDate, lastEditDate, title, description, deadline, completed, completedDate}
    </td>
  </tr>
  <tr>
    <td>
...
<table>
  ...
  <tr>
    ...
    <td>
      {idRequest}->{creationDate, title, description, approved}
    </td>
  </tr>
  <tr>
    <td>
...
<table>
  ...
  <tr>
    ...
    <td>
      {idComment}->{reationDate, lastEditDate, content}
    </td>
  </tr>
  <tr>
    <td>
...
<table>
  ...
  <tr>
    ...
    <td>
      {idBan}-> startDate, duration, motive}
    </td>
  </tr>
  <tr>
    <td>
