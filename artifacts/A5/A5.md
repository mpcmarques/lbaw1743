...
| R02                | Task(<u>idTask</u>, creationDate NN, lastEditDate, title NN, description, deadline, completed NN, completedDate CK completedDate > creationDate, idUser->UserTable NN, idProject->Project NN) |
...
2. Updated SQL so that we don't have to specify the schema.
3. Deleted Thread and ProjectForum Table from Relational Schema.
4. Added explanation to why our schema is in BCNF Form.
