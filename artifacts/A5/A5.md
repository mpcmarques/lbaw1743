...
| R02                | Task(<u>idTask</u>, creationDate NN, title NN, description, deadline, completed NN, completedDate, idUser->UserTable, idProject->Project) |
| R03                | Assigned(<u>idUser</u>->UserTable, <u>idTask</u>->Task) |
| R04                | EditTaskInfo(<u>idUser</u>->UserTable, <u>idTask</u>->Task, editDate NN, oldTitle NN, oldDescription, oldDeadline) |
...
| R09                | EditCommentInfo(<u>idUser</u>->UserTable, <u>idComment</u>->Comment, editDate NN, oldContent NN) |
...
| R12                | Joined(<u>idUser</u>->UserTable, <u>idProject</u>->Project, joinedDate NN, leftDate, role NN) |
...
| R19                | BannedRecord(<u>idBan</u>, startDate NN, duration CK duration > 0, motive, idUser->UserTable, idAdmin->Admin) |
...
<table>
  <tr>
    <th colspan="2">**Table R01** (UserTable)   </th>
  </tr>
  <tr>
    <td colspan="2">**Keys**: { idUser, username, email}</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>FD0101</td>
    <td>{idUser}->{username, password, email, premium, banned, name, gender, address, institution, description, birthDate}</td>
  </tr>
  <tr>
    <td>**Normal Form**</td>
    <td>BCNF</td>
