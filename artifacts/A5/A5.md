...
| R11                | Joined(<u>idUser</u>->UserTable, <u>idProject</u>->Project, joinedDate NN, leftDate, role NN) |
| R12                | PremiumSignature(<u>idPremium</u>, startDate NN, duration CK duration > 0 NN, idUser->User) |
| R13                | ProjectForum(<u>idForum</u>) |
| R14                | ForumPost(<u>idPost</u>, creationDate NN, title NN, content NN, idForum->Project Forum, idUser->User) |
| R15                | Reply(<u>idReply</u>, creationDate NN, content NN, idPost->ForumPost, idUser->User) |
| R16                | Country(<u>idCountry</u>, name UK NN) |
| R17                | Admin(<u>idAdmin</u> , username UK NN, password NN, email UK NN) |
| R18                | BannedRecord(<u>idBan</u>, startDate NN, duration CK duration > 0, motive, idUser->UserTable, idAdmin->Admin) |
...
<table>
  ...
  <tr>
    <td colspan="2">
      <b>Keys</b>:{idTask, creationDate, title, description, deadline, completed, completedDate}
    </td>
  </tr>
  <tr>
    <td colspan="2">
