...
<table>
  <tr>
    <th>URL</th>
    <td colspan="2">/dashboard_my_projects/{id}</td>
  </tr>
  <tr>
    <th>Description</th>
...
<table>
  <tr>
    <th>URL</th>
    <td colspan="2">/dashboard_my_tasks/{id}</td>
  </tr>
  <tr>
    <th>Description</th>
...
- R302: View Project Forum ```/dashboard_my_projects/{id}/{idProject}/project_forum``` <!-- TODO -->
- R303: View Project Options ```/dashboard_my_projects/{id}/{idProject}/project_options``` <!-- TODO -->
- R304: Create Project Form ```/dashboard/new_project``` <!-- TODO -->
- R305: Create Project Action ```/dashboard/new_project``` <!-- TODO -->
- R306: View Project Members ```/dashboard_my_projects/{id}/{idProject}/project_members``` <!-- TODO -->
- R307: Delete Project Members ```/dashboard_my_projects/{id}/{idProject}/project_manage_members``` <!-- TODO -->
- R308: Edit Project Members Form ```/dashboard_my_projects/{id}/{idProject}/project_manage_members/``` <!-- TODO -->
- R308: Edit Project Members Action ```/dashboard_my_projects/{id}/{idProject}/project_manage_members``` <!-- TODO -->
- R309: Create Project Task Form ```/dashboard_my_projects/'project_name'/create_task```
- R310: Remove Project Task Action ```/dashboard_my_projects/'project_name'/project_manage_tasks```
- R311: Edit Project Task Form ```/dashboard_my_projects/'project_name'/project_manage_tasks```
- R312: Edit Project Task Action ```/dashboard_my_projects/'project_name'/project_manage_tasks```
- R313: View Project Options ```/dashbaord_my_projects/'project_name'/project_options```
- R314: Browse Files Action ```/dashbaord_my_projects/'project_name'/project_options```
- R315: Upload Files Action ```/dashbaord_my_projects/'project_name'/project_options```
- R316: Edit Project Name Action ```/dashbaord_my_projects/'project_name'/project_options```
- R317: Edit Project Description Action ```/dashbaord_my_projects/'project_name'/project_options```
- R318: Save Project Changes Action ```/dashbaord_my_projects/'project_name'/project_options```

#### R301: View Project Tasks
<table>
  <tr>
    <th>URL</th>
    <td colspan="2">/dashboard_my_projects/{id}/{idProject}/tasks</td>
  </tr>
  <tr>
    <th>Description</th>
    <td colspan="2">Shows user's tasks.</td>
...
<table>
  <tr>
    <th>URL</th>
    <td colspan="2">/dashboard_my_projects/{id}/{idProject}/project_forum</td>
  </tr>
  <tr>
    <th>Description</th>
...
<table>
  <tr>
    <th>URL</th>
    <td colspan="2">/dashboard_my_projects/{id}/{idProject}/project_options</td>
  </tr>
  <tr>
    <th>Description</th>
...
<table>
  <tr>
    <th>URL</th>
    <td colspan="2">/dashboard_my_projects/{id}/{idProject}/project_members</td>
  </tr>
  <tr>
    <th>Description</th>
...
<table>
  <tr>
    <th>URL</th>
    <td colspan="2">/dashboard_my_projects/{id}/{idProject}/project_manage_members</td>
  </tr>
  <tr>
    <th>Description</th>
    <td colspan="2">This web resource logs a new project into the system. Redirects to the new project page page on success and the create project form on failure.</td>
  ...
  <tr>
    ...
    <td>Project member primary key</td>
  </tr>
  <tr>
