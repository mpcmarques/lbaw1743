...
- R101: Login Action ```/``` <!-- TODO -->
- R102: Logout Action ```/``` <!-- TODO -->
- R103: Register Action ```/``` <!-- TODO -->
...
<table>
  ...
  <tr>
    <th>Redirects</th>
    <td colspan="2"><a href="https://github.com/mpcmarques/lbaw1743/blob/master/artifacts/A7/A7.md#r304-create-project-form">R304</a></td>
  </tr>
  <tr>
    <th>Permissions</th>
    <td colspan="2">USR</td>
...
- R404: Search Users API ```/api/search_projects```
- R405: Search Tasks Action ```/search_tasks```
- R406: Search Tasks API ```/api/search_projects```
