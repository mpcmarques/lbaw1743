...
- R401: Search Projects Action ```/search/{text}/projects```
- R402: Search Projects API ```/search/{text}```
- R403: Search Users Action ```/search/{text}/users```
- R404: Search Users API ```/search/{text}```
- R405: Search Tasks Action ```/search/{text}/tasks```
- R406: Search Tasks API ```/search/{text}```
