...
- R315: Browse Files Action ```/dashboard/my_projects/{idProject}/options```

- R316: Upload Files Action ```/dashboard/my_projects/{idProject}/options```

- R317: Edit Project Action ```/dashboard/my_projects/{idProject}/options```
...
<table>
  ...
  <tr>
    <th>Submit</th>
    <td><a href="https://github.com/mpcmarques/lbaw1743/blob/master/artifacts/A7/A7.md#r309-edit-project-task-action">R309</a></th>
  </tr>
  <tr>
    <th>Permissions</th>
    <td colspan="2">MEM</td>
...
<table>
  ...
  <tr>
    <th>Redirects</th>
    <td><a href="https://github.com/mpcmarques/lbaw1743/blob/master/artifacts/A7/A7.md#r310-create-project-task-form">R310</a>R310</th>
  </tr>
  <tr>
    <th>Permissions</th>
    <td colspan="2">USR</td>
...
#### R315: Browse Files Action

<!-- TODO: /dashboard/my_projects/{idProject}/options -->

#### R316: Upload Files Action

<!-- TODO: /dashboard/my_projects/{idProject}/options -->

#### R317: Edit Project Action
