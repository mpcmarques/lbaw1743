...
- R309: Edit Project Members Action ```/dashboard/my_projects/{idProject}/manage_members```

- R310: Create Project Task Form ```/dashboard/my_projects/{idProject}/create_task```

- R311: Remove Project Task Action ```/dashboard/my_projects/{idProject}/manage_tasks```

- R312: Edit Project Task Form ```/dashboard/my_projects/{idProject}/manage_tasks```

- R313: Edit Project Task Action ```/dashboard/my_projects/{idProject}/manage_tasks```

- R314: View Project Options ```/dashboard/my_projects/{idProject}/options```
...
- R317: Edit Project Name Action ```/dashboard/my_projects/{idProject}/options```

- R318: Edit Project Description Action ```/dashboard/my_projects/{idProject}/options```

- R318: Save Project Changes Action ```/dashboard/my_projects/{idProject}/options```
...
<!-- TODO: /dashboard/my_projects/{idProject}/manage_members -->
...
<!-- TODO: /dashboard/my_projects/{idProject}/create_task -->

#### R311: Remove Project Task Form

<!-- TODO: /dashboard/my_projects/{idProject}/manage_tasks -->

#### R312: Edit Project Task Form

<!-- TODO: /dashboard/my_projects/{idProject}/manage_tasks -->

#### R313: Edit Project Task Action

<!-- TODO: /dashboard/my_projects/{idProject}/manage_tasks -->

#### R314: View Project Options
...
#### R316: Edit Project Description Action
