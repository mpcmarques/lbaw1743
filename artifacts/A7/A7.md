...
- R308: Edit Project Members Action ```/dashboard_my_projects/{idProject}/manage_members```

- R309: Create Project Task Form ```/dashboard/my_projects/{idProject}/create_task```

- R310: Remove Project Task Action ```/dashboard/my_projects/{idProject}/manage_tasks```

- R311: Edit Project Task Form ```/dashboard/my_projects/{idProject}/manage_tasks```

- R312: Edit Project Task Action ```/dashboard/my_projects/{idProject}/manage_tasks```

- R313: View Project Options ```/dashboard/my_projects/{idProject}/options```

- R314: Browse Files Action ```/dashboard/my_projects/{idProject}/options```

- R315: Upload Files Action ```/dashboard/my_projects/{idProject}/options```

- R316: Edit Project Name Action ```/dashboard/my_projects/{idProject}/options```

- R317: Edit Project Description Action ```/dashbaord/my_projects/{idProject}/options```
