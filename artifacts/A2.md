...
| US08 | Log in | high | As a Visitor, I want to authenticate into the system using a third party account.|
| US09 | Register | high | As a Visitor, I want to register myself into the system using a third party service.|
...
| Identifier | Name | Priority | Description |
| :----------:|:-------------:| :-----:|:-------|
| US10 | Search projects | high | As an Authenticated User, I want to search through the projects that are open to me, so that I can see which one i want to contribute the most.|
