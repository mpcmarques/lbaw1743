...
| Identifier | Name | Priority | Description |
| :----------:|:-------------:| :-----:|:-------|
| US11 | Search projects | high | As an User, I want to search through the projects that are open to me, so that ****.|
| US12 | Edit profile | high | As an User, I want to change the my information, so that I can keep it updated (e.g. changing the password).|
| US11 | Create project | high | As an User, I want to be able to create a project, so that ***.|
...
| Identifier  | Name          | Priority  | Description |
| :----------:|:-------------:| :-----:|:-------|
| US11 | Create Task | high | As a project member, I want to be able to add a task to the task list, so that we can keep improving the project.|
| US11 | Commentate Task | medium | As a project member, I want to be able to commentate ask, so that i can provide insight into a task|
| US11 | Search tasks | high | As a project member, I want to search through the different tasks, so that i can find one that is best suited for me.|
| US11 | Ask to close task | medium | As a project member, I want to be able to signal that a task has been completed, so that the project administrator can close it|
| US11 | Chat in the forum | medium | As a project member, I want to be able to  chat in the forum, so that i can contribute to the project via the discussion forum.|

### 2.2.2 Project Administrator
| Identifier  | Name          | Priority  | Description |
| :----------:|:-------------:| :-----:|:-------|
| US11 | Close Task | high | As a project administrator, I want to be able to fully close tasks that have been completed, so that they don't clutter the task list|
| US11 | Manage project member | medium | As a project administrator, I want to be able to add & remove project members, so that they can help complete our project|


### 2.2.3 Project Owner
| Identifier  | Name          | Priority  | Description |
| :----------:|:-------------:| :-----:|:-------|
| US11 | Transfer Ownership | medium | As a project owner, I want to be able to transfer ownership of a project, so that i am no longer burdened by it.|
| US11 | Manage project administrators| medium | As a project owner, I want to be able to add & remove project administrators, so that they can help me delegate and moderate.|
| US11 | Delete project | low | As a project owner, I want to be able to delete a project, so that a dead project no longer shows up in my projects.|
