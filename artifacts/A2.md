...
|:----------:|:------------|:--------|
| Visitor | *** | *** |
| User | Unauthenticated user, can see public projects but can't contribute to any of them | n/a |
...
| US03 | Home Page | high | As a User, I want to access home page, so that I can see a brief website's description.  |
| US04 | About page | high | As a User, I want to access about page, so that I can see the complete information about the website. |
| US05 | FAQ page | high | As a User, I want to access FAQ page, so that I can get answers to most frequently asked questions. |
| US06 | Contact page | high | As a User, I want to access contact page, so that I can have ways to contact the owner if I want to.|
...
| US09 | Register | high | As a User, I want to register myself into the system using a third party service.|
...
| US19 | Create Task Tags | high | As a project manager, I want, so that .|
| US19 | Delete Task Tags | high | As a project manager, I want  so that .|
| US19 | Edit Tasks | high | As a project manager, I want to edit a task, so that i can better convey what is needed.|
| US19 | Delete Task | high | As a project manager, I want to delete a task, so that .|
| US19 | Delete Task Comment | high | As a project manager, I want to delete a task comment, so that .|
...
| US19 | Delete Post | high | As a project manager, I want to delete a post, so that .|
| US19 | Delete Reply | high | As a project manager, I want to delete a reply to a post, so that .|
