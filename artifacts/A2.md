...
| Identifier | Name | Priority | Description |
| :----------:|:-------------:| :-----:|:-------|
| US10 | Create Projects | high | As a Administrator, I want to create open-source projects to all users.  |
| US11 | Delete Projects | high | As a Administrator, I want to delete projects with inappropriate content.  |
| US12 | Remove Comments | high | As a Administrator, I want to remove comments with inappropriate content/expressions.  |
| US13 | Accept User | high | As an Administrator, I want to accept the registration of a new system user, so that he can access restricted content.  |
| US14 | Ban User | high | As an Administrator, I want to record the inactivity of a system user, so that he can't longer access restricted contents of the site.  |
| US15 | Maintenance | low | As an Administrator, I want to be able to interrupt all activity to maintenance purposes.  |
| US16 | General Messages| low | As an Administrator, I want to send messages to all users.  |
