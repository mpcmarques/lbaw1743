...
| Identifier | Name | Priority | Description |
| :----------:|:-------------:| :-----:|:-------|
| US10 | Search projects | high | As an User, I want to search through the projects that are open to me, so that ****.|
| US11 | Edit profile | high | As an User, I want to change the my information, so that I can keep it updated (e.g. changing the password).|
| US12 | Create project | high | As an User, I want to be able to create a project, so that ***.|
...
| US15 | Commentate Task | medium | As a project member, I want to be able to commentate ask, so that i can provide insight into a task|
...
| US20 | Manage project member | medium | As a project administrator, I want to be able to add & remove project members, so that they can help complete our project|
...
| US22 | Manage project administrators| medium | As a project owner, I want to be able to add & remove project administrators, so that they can help me delegate and moderate.|
...
| Identifier  | Name          | Priority  | Description |
| :----------:|:-------------:| :-----:|:-------|
| US24| Create Projects | high | As a Website Administrator, I want to create open-source projects to all users.|
| US25| Delete Projects | high | As a Website Administrator, I want to delete projects with inappropriate content.|
| US26| Remove Comments | high | As a Website Administrator, I want to remove comments with inappropriate content/expressions.|
...
| US29| Maintenance     | low | As an Website Administrator, I want to be able to interrupt all activity to maintenance purposes.|
| US30| General Messages| low | As an Website Administrator, I want to send messages to all users.|
