...
<table>
    ...
    <tr>
        <td><b>SQL Code</b></td>
        <td><code "sql">SELECT username, email, gender, description
                        FROM UserTable;</code></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><code "sql">SELECT username, email, gender, description
        FROM UserTable
        WHERE UserTable.idUser= $idUser;</code></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td><b>SQL Code</b></td>
        <td><code "sql">SELECT title
        FROM Task
        WHERE Task.idUser=$idUser
        ORDER BY deadline ASC;</code></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td><b>SQL Code</b></td>
        <td><code "sql">SELECT Project.name FROM Project, Joined, UserTable
        WHERE Project.idProject=Joined.idProject
        AND Joined.idUser=UserTable.idUser
        AND UserTable.idUser = $idUser;</code></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td><b>SQL Code</b></td>
        <td><code "sql">SELECT startDate, duration, name
        FROM PremiumSignature, UserTable
        WHERE UserTable.idUser= PremiumSignature.idUser;</code></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td><b>SQL Code</b></td>
        <td><code "sql">SELECT startDate, duration, motive
        FROM UserTable, BannedRecord
        WHERE BannedRecord.idUser = $idUser
        AND UserTable.idUser = BannedRecord.idUser;</code></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td><b>SQL Code</b></td>
        <td><code "sql">SELECT creationDate, name, description
        FROM Project
        WHERE idProject = $idProject;</code></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td><b>SQL Code</b></td>
        <td><code "sql">SELECT DISTINCT username, name, email
        FROM UserTable, Joined, Project
        WHERE Joined.idProject=$idProject
        AND Joined.role == 'Owner'
        AND Joined.idUser=UserTable.idUser;</code></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td><b>SQL Code</b></td>
        <td><code "sql">SELECT UserTable.name, Reply.creationDate, Reply.content, Reply.idPost
        FROM Reply, ForumPost, UserTable
        WHERE Reply.idPost = $idPost
        AND Reply.idUser = UserTable.idUser;</code></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td><b>SQL Code</b></td>
        <td><code "sql">SELECT title, deadline
...
<table>
    ...
    <tr>
        <td><b>SQL Code</b></td>
        <td><code "sql">SELECT title, creationDate,lastEditDate, description, deadline
        FROM Task
        WHERE Task.idTask= $idTask;</code></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td><b>SQL Code</b></td>
        <td><code "sql">SELECT Comment.creationDate, Comment.lastEditDate, Comment.content, name
        FROM Comment, UserTable, Task
        WHERE Task.idTask = $idTask
        AND Comment.idUser = UserTable.idUser
        AND Comment.idTask = Task.idTask;</code></td>
    </tr>
</table>
...
<table>
  <tbody>
    ...
    <tr>
      <td colspan="2">
        <code>
          INSERT INTO "UserTable" (username, password, email, name, gender, address,institution, description, birthDate, idCountry) VALUES ($username, $password, $email, $name, $gender, $address, $institution, $description, $birthDate, $idCountry);
        </code>
      </td>
    </tr>
  <tbody>
...
<table>
  <tbody>
    ...
    <tr>
      <td colspan="2">
        <code>
          INSERT INTO "Project"(creationDate, name, description, private, idForum) VALUES ($creationDate, $name, $description, $private, $idForum);
        </code>
      </td>
    </tr>
  <tbody>
...
<table>
  <tbody>
    ...
    <tr>
      <td colspan="2">
        <code>
          INSERT INTO "Task"(creationDate, lastEditDate, title, description, deadline, completed, completedDate, idUser, idProject) VALUES ($creationDate, $lastEditDate, $title, $description, $deadline, $completed, $completedDate, $idUser, $idProject);
        </code>
      </td>
    </tr>
  <tbody>
...
<table>
  <tbody>
    ...
    <tr>
      <td colspan="2">
        <code>
          INSERT INTO "Comment"(creationDate, lastEditDate, content, idTask, idUser, idComment) VALUES ($creationDate, $lastEditDate, $content, $idTask, $idUser, $idComment);
        </code>
      </td>
    </tr>
  <tbody>
...
<table>
  <tbody>
    ...
    <tr>
      <td colspan="2">
        <code>
          INSERT INTO "PremiumSignature"(startDate, duration, idUser) VALUES ($startDate, $duration, $idUser);
        </code>
      </td>
    </tr>
  <tbody>
...
<table>
  <tbody>
    ...
    <tr>
      <td colspan="2">
        <code>
          INSERT INTO "ForumPost"(creationDate, lastEditDate, title, content, idForum, idUser) VALUES ($creationDate, $lastEditDate, $title, $content, $idForum, $idUser);
        </code>
      </td>
    </tr>
  <tbody>
...
<table>
  <tbody>
    ...
    <tr>
      <td colspan="2">
        <code>
          INSERT INTO "Assigned"(idUser, idTask) VALUES ($idUser, $idTask);
        </code>
      </td>
    </tr>
  <tbody>
...
<table>
  <tbody>
    ...
    <tr>
      <td colspan="2">
        <code>
          INSERT INTO "CloseRequest"(creationDate, title, description, approved, idUser, idTask) VALUES ($creationDate, $title, $description, $approved, $idUser, $idTask);
        </code>
      </td>
    </tr>
  <tbody>
...
<table>
  <tbody>
    ...
    <tr>
      <td colspan="2">
        <code>
          INSERT INTO "Reply"( creationDate, lastEditDate, content, idPost, idUser) VALUES ($creationDate, $lastEditDate, $content, $idPost, $idUser);
        </code>
      </td>
    </tr>
  <tbody>
...
<table>
  <tbody>
    ...
    <tr>
      <td colspan="2">
        <code>
          INSERT INTO "Joined"(idUser, idProject, joinedDate, role) VALUES ($idUser, $idProject, $joinedDate, $role);
        </code>
      </td>
    </tr>
  <tbody>
